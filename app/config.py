...
def load_app_config(path: Path = DEFAULT_CONFIG_PATH) -> AppConfig:
    ...
    return AppConfig(
        ...
        random_fill_count=parser.getint("limits", "random_fill_count", fallback=20),
        max_random_attempts=parser.getint("limits", "max_random_attempts", fallback=1000),
        random_id_min=parser.getint("limits", "random_id_min", fallback=1),
        random_id_max=parser.getint("limits", "random_id_max", fallback=99999999),
